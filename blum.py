    ...
    try:
        with MySession() as session:
            ...
            def get_user_info(token):
                ...
                response = session.get('https://gateway.blum.codes/v1/user/me', headers=headers)
                if response.status_code == 200:
            ...
            def get_balance(token):
                ...
                response = session.get('https://game-domain.blum.codes/api/v1/user/balance', headers=headers)
                return response.json()
            ...
            def play_game(token):
                ...
                response = session.post('https://game-domain.blum.codes/api/v1/game/play', headers=headers)
                return response.json()
            ...
            def claim_balance(token):
                ...
                response = session.post('https://game-domain.blum.codes/api/v1/farming/claim', headers=headers)
                return response.json()
            ...
            def check_balance_friend(token):
                ...
                response = session.get('https://gateway.blum.codes/v1/friends/balance', headers=headers)
            ...
            def claim_balance_friend(token):
                ...
                response = session.post('https://gateway.blum.codes/v1/friends/claim', headers=headers)
                return response.json()
