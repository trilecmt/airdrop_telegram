...
import pandas as pd
import traceback
from helper.utils import print_message, print_welcome, sleep, format_number, get_query_id
...
headers={
  ...
  'sec-ch-ua': '"Google Chrome";v="125", "Chr333333333omium";v="125", "Not.A/Brand";v="24"',
  'sec-ch-ua-mobile': '?0',
